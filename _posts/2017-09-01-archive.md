...
{% assign i = 0 %}
{% for post in site.posts %}{% assign year = post.date | date: page.jekyll-theme-yueyazhui.archive.group_by %}{% assign nyear = post.next.date | date: page.jekyll-theme-yueyazhui.archive.group_by %}{% if year != nyear %}
